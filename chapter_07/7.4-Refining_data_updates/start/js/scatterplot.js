const drawScatterplot = (data) => {
  ...
  yScale = d3.scaleLinear().domain([0, maxSize]).range([innerHeight, 0]).nice();
  ...
  rScale = d3.scaleRadial().domain([0, maxWeigth]).range([0, 45]);
  ...
  innerChart.append("g").attr("class", "axis-y").call(leftAxisGenerator);
